require([
    ...
    new SearchManager({
        ...
        latest_time: "now",
        cache: true,
        search:'index=\"winevents_app\" sourcetype=\"WinEventLog:Application\" SourceName=\"Shopper*\" OR ' +
         'SourceName=\"RewardsService\" OR SourceName=\"CreditApprovalService\" AND SourceName!=\"ShopperInterestsApi\" | ' +
         'dedup SourceName | table SourceName'
    });

    var sourceName = new DropdownView({ //using the variable DropdownView to create a selection of choices
        id: "sourceName",
        default: "ShopperWalletApi",
        managerid: "dropdownChoices",
        labelField: "SourceName",
        valueField: "SourceName",
        value: mvc.tokenSafe("$sourceName$"),
        el: $("#sourceDrop")
    }).render();
